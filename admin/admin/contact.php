					...
					<div class="rows">
						...
						<?php
							if(isset($_POST['edit']))
							{
                                ...
                                $qry = mysql_query("update contact set des='$des',address='$address',telp='$telp',wa='$wa',ig='$ig',fb='$fb',web='$web',cp='$cp' where id='1'");
                                ?>
                                <script>
                                alert("Anda telah melakukan perubahan data")
                                window.location="home.php?p=contact";
                                </script>
                                <?php
						...
						<!--selesai-->
							<form class="form-horizontal" id="formeditadmin" method="post" action="">
								<div class="form-group">
                                   ...
                                   <div class="form-group">
				                  	<label class="col-md-3">CP</label>
				                  	<div class="col-md-9">
				                  		<input type="text" class="form-control" name="cp" value="<?php echo  $hasil['cp']; ?>">
				               		</div>
				               	</div>
								<div class="form-group">
